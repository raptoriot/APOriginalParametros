        ...
        try {
            ...
            while (cur.moveToNext()) {
                ...
                switch (cur.getInt(cur.getColumnIndex("alerta_nivel"))) {
                    case 1:
                        t_header_alerta.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.amarillo_2));
                        break;
                    case 2:
                        t_header_alerta.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.naranjo_2));
                        break;
                    case 3:
                        t_header_alerta.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.rojo_2));
                        break;
                    default:
                        t_header_alerta.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.gris_2));
                        break;
                }
